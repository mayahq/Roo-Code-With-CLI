...
<br>
<div align="center">
  <h2>Únete a la comunidad de Roo Code With CLI</h2>
...
<div align="center">
<h1>Roo Code With CLI (antes Roo Cline)</h1>

<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline-with-cli" target="_blank"><img src="https://img.shields.io/badge/Descargar%20en%20VS%20Marketplace-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="Descargar en VS Marketplace"></a>
...
<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline-with-cli&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/Valorar%20%26%20Opinar-green?style=for-the-badge" alt="Valorar & Opinar"></a>
...
**Roo Code With CLI** es un **agente de programación autónomo** impulsado por IA que vive en tu editor. Puede:
...
Ya sea que busques un socio de programación flexible, un arquitecto de sistemas o roles especializados como ingeniero de control de calidad o gestor de productos, Roo Code With CLI puede ayudarte a construir software de manera más eficiente.

Consulta el [CHANGELOG](../CHANGELOG.md) para ver actualizaciones detalladas y correcciones.

---

## 🎉 Roo Code With CLI 3.11 Lanzado

¡Roo Code With CLI 3.11 trae mejoras significativas de rendimiento y nuevas funcionalidades!
...
## ¿Qué puede hacer Roo Code With CLI?
...
1. [Instalar Roo Code With CLI](https://docs.roocode.com/getting-started/installing)
...
Roo Code With CLI se adapta a tus necesidades con [modos](https://docs.roocode.com/basic-usage/using-modes) especializados:
...
Roo Code With CLI viene con potentes [herramientas](https://docs.roocode.com/basic-usage/how-tools-work) que pueden:
...
MCP amplía las capacidades de Roo Code With CLI al permitirte añadir herramientas personalizadas ilimitadas. Integra con APIs externas, conéctate a bases de datos o crea herramientas de desarrollo especializadas - MCP proporciona el marco para expandir la funcionalidad de Roo Code With CLI para satisfacer tus necesidades específicas.

### Personalización

Haz que Roo Code With CLI funcione a tu manera con:
...
¡Gracias a todos nuestros colaboradores que han ayudado a mejorar Roo Code With CLI!
