...
<br>
<div align="center">
  <h2>Rejoignez la communauté Roo Code With CLI</h2>
...
<div align="center">
<h1>Roo Code With CLI (anciennement Roo Cline)</h1>

<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline-with-cli" target="_blank"><img src="https://img.shields.io/badge/T%C3%A9l%C3%A9charger%20sur%20VS%20Marketplace-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="Télécharger sur VS Marketplace"></a>
...
<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline-with-cli&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/%C3%89valuer%20%26%20Commenter-green?style=for-the-badge" alt="Évaluer & Commenter"></a>
...
**Roo Code With CLI** est un **agent de programmation autonome** propulsé par l'IA, au cœur de votre éditeur. Il peut :
...
Que vous recherchiez un partenaire de codage flexible, un architecte système, ou des rôles spécialisés comme un ingénieur QA ou un chef de produit, Roo Code With CLI peut vous aider à développer des logiciels plus efficacement.

Consultez le [CHANGELOG](../CHANGELOG.md) pour des mises à jour détaillées et des corrections.

---

## 🎉 Roo Code With CLI 3.11 est sorti

Roo Code With CLI 3.11 apporte des améliorations significatives de performance et de nouvelles fonctionnalités !
...
## Que peut faire Roo Code With CLI ?
...
1. [Installer Roo Code With CLI](https://docs.roocode.com/getting-started/installing)
...
Roo Code With CLI s'adapte à vos besoins avec des [modes](https://docs.roocode.com/basic-usage/using-modes) spécialisés :
...
Roo Code With CLI est livré avec des [outils](https://docs.roocode.com/basic-usage/how-tools-work) puissants qui peuvent :
...
MCP étend les capacités de Roo Code With CLI en vous permettant d'ajouter un nombre illimité d'outils personnalisés. Intégrez des API externes, connectez-vous à des bases de données ou créez des outils de développement spécialisés - MCP fournit le cadre pour étendre la fonctionnalité de Roo Code With CLI afin de répondre à vos besoins spécifiques.

### Personnalisation

Faites fonctionner Roo Code With CLI à votre manière avec :
...
Merci à tous nos contributeurs qui ont aidé à améliorer Roo Code With CLI !
