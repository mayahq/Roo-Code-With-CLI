...
<br>
<div align="center">
  <h2>Roo Code With CLI Topluluğuna Katılın</h2>
...
<div align="center">
<h1>Roo Code With CLI (önceki adıyla Roo Cline)</h1>

<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline-with-cli" target="_blank"><img src="https://img.shields.io/badge/VS%20Marketplace%27den%20İndir-blue?style=for-the-badge&logo=visualstudiocode&logoColor=white" alt="VS Marketplace'den İndir"></a>
...
<a href="https://marketplace.visualstudio.com/items?itemName=RooVeterinaryInc.roo-cline-with-cli&ssr=false#review-details" target="_blank"><img src="https://img.shields.io/badge/Değerlendir%20%26%20İnceleme-green?style=for-the-badge" alt="Değerlendir & İnceleme"></a>
...
**Roo Code With CLI**, editörünüzde çalışan yapay zeka destekli **otonom kodlama aracı**dır. Yapabilecekleri:
...
İster esnek bir kodlama ortağı, ister bir sistem mimarı, isterse QA mühendisi veya ürün yöneticisi gibi uzmanlaşmış roller arıyor olun, Roo Code With CLI yazılım geliştirme sürecinizi daha verimli hale getirmenize yardımcı olabilir.

Detaylı güncellemeler ve düzeltmeler için [CHANGELOG](../CHANGELOG.md) dosyasını kontrol edin.

---

## 🎉 Roo Code With CLI 3.11 Yayınlandı

Roo Code With CLI 3.11 önemli performans iyileştirmeleri ve yeni özellikler getiriyor!
...
## Roo Code With CLI Ne Yapabilir?
...
1. [Roo Code With CLI'u Yükleyin](https://docs.roocode.com/getting-started/installing)
...
Roo Code With CLI, özelleştirilmiş [modlar](https://docs.roocode.com/basic-usage/using-modes) ile ihtiyaçlarınıza uyum sağlar:
...
Roo Code With CLI, şunları yapabilen güçlü [araçlar](https://docs.roocode.com/basic-usage/how-tools-work) ile gelir:
...
MCP, sınırsız özel araç eklemenize izin vererek Roo Code With CLI'un yeteneklerini genişletir. Harici API'lerle entegre olun, veritabanlarına bağlanın veya özel geliştirme araçları oluşturun - MCP, Roo Code With CLI'un işlevselliğini özel ihtiyaçlarınızı karşılamak üzere genişletmek için çerçeve sağlar.

### Özelleştirme

Roo Code With CLI'u kendi tarzınıza göre çalıştırın:
...
4. **Hata ayıklama**:
   VSCode'da `F5` tuşuna basın (veya **Run** → **Start Debugging**) Roo Code With CLI yüklenmiş yeni bir oturum açmak için.
...
Roo Code With CLI'u daha iyi hale getirmeye yardımcı olan tüm katkıda bulunanlara teşekkür ederiz!
